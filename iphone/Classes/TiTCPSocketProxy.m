...
@implementation TiTCPSocketProxy
...
/*
 * NOTE: 'init' is not allowed because of how the parent class uses _initWithPageContext -
 * which calls its own init method.  This should be discouraged.
-(id)init
{
	return [self initWithContext:nil host:nil port:0 mode:READ_MODE];
}
 */
...
void handleSocketConnection(CFSocketRef socket, CFSocketCallBackType type, 
    ...
    switch (type) {
        case kCFSocketAcceptCallBack: {
            TiTCPSocketProxy* hostSocket = (TiTCPSocketProxy*)info;
